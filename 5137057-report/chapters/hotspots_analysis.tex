...
\\
\noindent
The main hotspot is the loop contained in lines 72-80 (source: \texttt{src/omp\_homework.c}). The dominant operations contributing to the algorithm's computational intensity are the \texttt{sin()} and \texttt{cos()} trigonometric functions, which account for the majority of the execution time, as shown in the figure.
