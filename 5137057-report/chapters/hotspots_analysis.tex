...
\noindent
The goal of this analysis is to identify the parts of the program that consume the most execution time. To reach this objective, I have considered data size resulting in sequential time $\sim 30$ seconds, setting $N = 100'000$. Each execution was empirically repeated 10 times
