...
\subsubsection*{Ideal case \texorpdfstring{ ($f_s=0$)}{ (fs=0)}}
\addcontentsline{toc}{subsubsection}{Ideal case}
...
\subsubsection*{Theoretical limit case \texorpdfstring{ ($p \to \infty $)}{ (p->inf)}}
\addcontentsline{toc}{subsubsection}{Theoretical limit case}
...
\subsubsection*{Real case \texorpdfstring{ ($f_s=\alpha p$)}{ (fs=ap)}}
\addcontentsline{toc}{subsubsection}{Real case}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{assets/amdalhs_law/parallel_comparison.jpg}
