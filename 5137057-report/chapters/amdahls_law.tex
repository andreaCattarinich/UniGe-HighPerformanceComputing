...
\subsubsection*{Real case ($S=\alpha p$)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/classic_vs_overhead.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/parallel_comparison.jpg}
