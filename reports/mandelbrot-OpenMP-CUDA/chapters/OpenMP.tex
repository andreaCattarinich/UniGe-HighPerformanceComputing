...
\begin{center}
    \includegraphics[width=0.65\textwidth]{assets/openmp/omp2_execution.png}

    \includegraphics[width=0.65\textwidth]{assets/openmp/omp2_speedup.png}

    \includegraphics[width=0.65\textwidth]{assets/openmp/omp2_efficiency.png}    
\end{center}
