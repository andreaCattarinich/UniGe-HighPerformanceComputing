...
\subsection{Parallelization over the outer loop}
In the first approach (\texttt{src/omp1.c}), the outer loop over the frequency index $k$ is parallelized.
...
\subsection*{Attempted Optimization}
