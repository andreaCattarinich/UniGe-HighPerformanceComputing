...
int main(int argc, char* argv[]){
  ...
  printf("- fillInput() time: %.5f seconds\n", end-start);
  ...
  printf("- setOutputZero1() time: %.5f seconds\n", end-start);
  ...
  printf("- setOutputZero2() time: %.5f seconds\n", end-start);
  ...
  printf("- checkResults() time: %.5f seconds\n", end-start);
  ...
  printf("- printResults() time: %.5f seconds\n", end-start);
#endif
